...
mixin _$APIResponse<T> {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(T data, String? msg) success,
    required TResult Function(AppException exception) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T data, String? msg)? success,
...
class _$APISuccess<T> implements APISuccess<T> {
  const _$APISuccess(this.data, {this.msg});
  ...
  @override
  String toString() {
    return 'APIResponse<$T>.success(data: $data, msg: $msg)';
  }
...
abstract class APISuccess<T> implements APIResponse<T> {
  const factory APISuccess(final T data, {final String? msg}) = _$APISuccess<T>;
